...
static void InitDefaultsscc_info_Example_example_2eproto() {
  ...
  {
    void* ptr = &::et::proto::_Example_default_instance_;
    new (ptr) ::et::proto::Example();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::et::proto::Example::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Example_example_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Example_example_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_example_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::et::proto::Example, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::et::proto::Example, val_1_),
  PROTOBUF_FIELD_OFFSET(::et::proto::Example, val_2_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::et::proto::Example)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::et::proto::_Example_default_instance_),
};

const char descriptor_table_protodef_example_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rexample.proto\022\010et.proto\"\'\n\007Example\022\r\n\005"
  "val_1\030\001 \001(\t\022\r\n\005val_2\030\002 \001(\005b\006proto3"
  ;
...
Example::Example(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:et.proto.Example)
}
Example::Example(const Example& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  val_1_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_val_1().empty()) {
    val_1_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_val_1(),
      GetArena());
  }
  val_2_ = from.val_2_;
  // @@protoc_insertion_point(copy_constructor:et.proto.Example)
}
...
Example::~Example() {
  // @@protoc_insertion_point(destructor:et.proto.Example)
  SharedDtor();
...
void Example::SharedDtor() {
  ...
  val_1_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
void Example::Clear() {
// @@protoc_insertion_point(message_clear_start:et.proto.Example)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "et.proto.Example.val_1"));
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* Example::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:et.proto.Example)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  // string val_1 = 1;
  if (this->val_1().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_val_1().data(), static_cast<int>(this->_internal_val_1().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "et.proto.Example.val_1");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:et.proto.Example)
  return target;
}

size_t Example::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:et.proto.Example)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:et.proto.Example)
  GOOGLE_DCHECK_NE(&from, this);
  const Example* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Example>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:et.proto.Example)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:et.proto.Example)
    MergeFrom(*source);
  }
}

void Example::MergeFrom(const Example& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:et.proto.Example)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  if (from.val_1().size() > 0) {
...
// @@protoc_insertion_point(generalized_copy_from_start:et.proto.Example)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:et.proto.Example)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Example::InternalSwap(Example* other) {
  ...
  val_1_.Swap(&other->val_1_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  swap(val_2_, other->val_2_);
}
...
template<> PROTOBUF_NOINLINE ::et::proto::Example* Arena::CreateMaybeMessage< ::et::proto::Example >(Arena* arena) {
  return Arena::CreateMessageInternal< ::et::proto::Example >(arena);
}
